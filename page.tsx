  ...
  const profiles = [
    {
      ...
      valueProp: "Enterprise-grade defense solutions",
      pricePoint: "$$$",
    },
    {
      id: 2,
      ...
      valueProp: "Process automation with 40% efficiency gain",
      pricePoint: "$$",
    },
    {
      id: 3,
      ...
      valueProp: "Scalable infrastructure for mid-market businesses",
      pricePoint: "$$",
    },
  ];
        ...
        <Card className="w-96 shadow-xl mb-4">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Price: {currentProfile.pricePoint}
            </p>
          </CardContent>
        </Card>
      )}
        ...
        <div className="mt-8 w-full max-w-md p-4 bg-white rounded-lg shadow-md">
          ...
          <ul className="space-y-2">
            {matches.map((m) => (
              <li
                key={m.id}
                className="p-2 bg-green-100 rounded-md border border-green-300"
              >
                {m.name} — {m.industry}
              </li>
            ))}
